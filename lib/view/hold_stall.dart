...
//   final List<String> stallIds; // Changed from stallId to stallIds
...
//                             try {
//                               String holdExpiry;
//                               if (widget.stallIds.length == 1) {
//                                 // Single stall hold
//                                 final holdingData = {
//                                   'stallId': widget.stallIds.first,
//                                   'businessName': 'Unknown', // Adjust as needed
//                                   'businessPhone':
//                                       'Unknown', // Adjust as needed
//                                   'businessEmail':
//                                       'unknown@example.com', // Adjust as needed
//                                   'contactPersonName':
...
//                                       content: Text(
//                                         'Your ${widget.stallIds.length} stall(s) have been held. Please complete payment by ${formatDateManually(DateTime.parse(stalls[]))} to confirm booking, or the hold will be released!',
                                ...
                                builder: (context) {
                                  return AlertDialog(
                                    ...
                                    title: const Icon(Icons.check_circle,
                                        color: Colors.blue, size: 40),
                                    content: Text(
                                      'Your ${widget.stallIds.length} stall(s) have been held. Please complete payment by ${formatDateManually(DateTime.parse(holdExpiry))} to confirm booking, or the hold will be released!',
                                      style: const TextStyle(
                                          fontWeight: FontWeight.bold),
                                    ),
                                    actions: [
